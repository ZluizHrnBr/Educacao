...
const TabelaFormacaoEquipe = ({onClickFormarEquipe}) => {
    return(
            ...
            <div className="col-lg-12">
                <div className="card">
                    ...
                    <div className="d-flex justify-content-between">
                        <button className="btn btn-primary" onClick={onClickFormarEquipe}>Formar Equipe</button>
                    </div>
                    </div>
                </div>
            </div>
...
export default TabelaFormacaoEquipe;